...
public class LambdaExpressionDemo {
	...
	public static void main(String[] args) {
		...
		// classes
		LambdaInterface lambdaExpression1 = () -> System.out.println("Show method calling in Inner class by lambda expression for single line functionality");
		LambdaInterface lambdaExpression2 = () -> {
			System.out.println("Show method calling in Inner class by lambda expression2");
		...
		LambdaInterfaceGetName getName = (String name) -> System.out.println("My name is " + name);
		LambdaInterfaceGetName getNameSimplified = name -> System.out.println("My name is " + name + " getting by simplified code");
